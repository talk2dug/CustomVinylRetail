...
if (require.main === module) {
  server.listen(PORT, HOST, () => {
    ...
    // Timelapse capture — DISABLED on VPS (too much lag from polling).
    // Capture now runs locally in Print Station (print-station/src/timelapse-capture.js)
    // which detects layer changes via WebSocket and captures during the G4 dwell window.
    // The VPS still serves the /api/timelapse/* routes for listing/streaming completed videos.
    // try {
